...
[![Build Status](https://builds.gbif.org/job/hp-ahmet/badge/icon)](https://builds.gbif.org/job/hp-ahmet/lastBuild/console)
...
# GBIF Hosted Portal: ahmet

This Jekyll website, **[ahmet (Staging)](https://ahmet.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
